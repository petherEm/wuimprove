        ...
        <div className="flex flex-col px-4 text-white">
          ...
          <div className="alert alert-error shadow-lg">
            <div>
              ...
              <span>Get verified to enjoy your funds</span>
            </div>
          </div>
          ...
          <div className="flex justify-between">
            <div>
              <p className="text-[14px]">Bonus (pending)</p>
              <h1 className="text-2xl font-extrabold">100 RON</h1>
            </div>
          ...
          <div className="mt-8 flex items-center justify-around">
            <button
              ...
              className="text-[18px] rounded-full bg-gray-400 px-8 py-2 text-black hover:bg-yellow-600"
            >
              Add Money
            </button>
            <button
          ...
          <div>
            <div className="mb-8 collapse flex flex-col items-center">
              <input type="checkbox" className="peer" />
              <div className="collapse-title text-center w-fit bg-yellow-400 text-black peer-checked:bg-yellow-600 peer-checked:text-black rounded-full">
                Do you need to cash out now?
              </div>
              <div className="collapse-content bg-yellow-400 text-black peer-checked:bg-yellow-600 peer-checked:text-black">
                <p>1. Find the nearest Western Union location</p>
                <p>2. Bring your ID</p>
                <p>
                  3. Provide your ID, MTCN and transaction details to the agent
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-between">
            <p className="text-[14px]">Debit card (pending verification)</p>
          ...
          <div className="mt-4 mb-4 flex flex-col">
            ...
            <div className="mt-4 flex items-center justify-around">
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="text-[12px] font-bold">Denisa</p>
              </div>
              <div className="flex flex-col items-center justify-center">
                <div className="relative h-14 w-14 rounded-full border-2 border-yellow-300">
                  <p className="absolute top-3 left-3 text-[18px] font-bold">
                ...
                <p className="text-[12px] font-bold">Denisa Euro</p>
              </div>
            </div>
          </div>
